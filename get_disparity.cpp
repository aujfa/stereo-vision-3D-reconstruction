...
static void getDisparity() {
	cv::Mat img1, img2;

	img1 = cv::imread("imR.jpg", cv::IMREAD_GRAYSCALE);
	img2 = cv::imread("imL.jpg", cv::IMREAD_GRAYSCALE);
	...
	//include this for seeing fundamental matrix
	cout << fundamental;
